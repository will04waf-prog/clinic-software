...
export const CLIENT_TEMPLATES: Record<ClientTemplateType, ClientTemplate> = {
  estimate_ready: {
    ...
    es: {
      ...
      language: 'es',
      category: 'UTILITY',
      body: 'Hola {{1}}, {{2}} le envió un estimado. Revise el trabajo y el precio, y apruébelo con un toque aquí: {{3}}. ¿Tiene preguntas? Responda a este mensaje.',
  ...
  estimate_approved: {
    ...
    es: {
      name: 'estimado_aprobado',
      language: 'es',
      category: 'UTILITY',
      body: '¡Gracias {{1}}! Su aprobación del estimado de {{2}} quedó confirmada. Se comunicarán con usted para agendar el trabajo. Le enviaremos un recordatorio antes de la visita.',
