 ...
 *
 * Public-facing page describing how voice calls placed to clinics
 ...
 * fallback the clinic can link to in their own intake materials
    ...
    <div className="min-h-screen bg-[#F5EFE1] flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-16 space-y-6 text-gray-700 text-sm leading-7">
          ...
          <p>
            Some clinics that use Tarhunna route their inbound phone line to an AI receptionist. When you call such a clinic, the AI answers, helps you with appointments or general questions, and may record the call for quality and record-keeping.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>The AI can answer general questions (hours, services, location), book appointments, take messages, and transfer you to a human team member.</li>
            <li>If you raise an emergency or medical question the AI cannot answer, it will transfer you to the clinic's team or take a message.</li>
          ...
          <p>
            Recordings and AI-generated transcripts are stored by the clinic as part of your patient record. They are subject to the same protections the clinic uses for any other patient information (HIPAA where applicable, plus the clinic's own privacy practices). Recordings and transcripts are not shared with third parties for marketing.
          </p>

          <h2 className="text-lg font-semibold text-gray-900 pt-4">Refusing to be recorded</h2>
          <p>
            You can refuse to be recorded by saying "no recording" when the AI prompts you. The call continues. The clinic will still receive a brief summary of what was discussed (without audio), but no recording or full transcript will be stored.
          </p>
          ...
          <p>
            Contact the clinic directly to request access to, correction of, or deletion of recordings and transcripts of your calls. The clinic — not Tarhunna — is the data controller for your patient record.
          </p>
