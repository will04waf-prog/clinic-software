          ...
          <div className="prose prose-gray max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <section>
              <p>
                ...
                small businesses in the United States &mdash; service companies such as landscaping
                businesses, as well as clinics &mdash; to communicate with their customers. This page describes how SMS communications work through
            ...
            <section>
              ...
              <p>
                SMS consent is <strong>not required</strong>{' '}to use any business&apos;s service.
                Customers can submit intake or estimate-request forms, schedule appointments,
                and receive service from businesses on the Tarhunna platform without ever consenting to SMS
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">How customers opt in to receive SMS</h2>
              <p>
                When a customer submits an intake or appointment-request form on a business&apos;s
              ...
              <blockquote className="mt-4 border-l-4 border-gray-200 pl-4 italic text-gray-600">
                &ldquo;I agree to receive appointment reminders by SMS from [Business Name].
              ...
              <figure className="mt-6 rounded-lg border border-gray-200 bg-white overflow-hidden">
                <Image
                  ...
                  alt="Tarhunna intake form showing the optional SMS consent checkbox unchecked, with full label text and the submit button."
                  width={2930}
                  height={1594}
                ...
                <figcaption className="border-t border-gray-100 px-4 py-3 text-sm text-gray-500 italic leading-relaxed">
                  Example: Tarhunna&apos;s intake form as it appears to a customer on a business&apos;s website. The SMS consent checkbox appears at the bottom of the form, unchecked by default. Customers may submit the form with or without checking this box; submission is not contingent on consenting to SMS.
                </figcaption>
              </figure>
              <p className="mt-4">
                Customers may submit the form with or without checking this box. If unchecked, the
                business still receives the customer&apos;s information and may follow up by phone
                or email as the customer prefers &mdash; but no SMS will ever be sent to that
                number.
              </p>
              <p className="mt-4">
                A customer may also provide express written consent through:
              </p>
              <ul className="list-disc pl-5 mt-3 space-y-2">
                <li>A paper intake form at the business with a separate SMS consent line</li>
            ...
            <section>
              ...
              <p>
                If a customer has consented, Tarhunna sends the following types of SMS messages
                on behalf of businesses:
              </p>
              <ul className="list-disc pl-5 mt-3 space-y-2">
                <li>Appointment and job reminders (typically 24 hours and 2 hours before a scheduled visit)</li>
                <li>Appointment confirmations after booking</li>
                <li>Follow-up messages from the business to the customer (for example, an estimate or invoice link)</li>
              </ul>
              <p className="mt-4">
                All messages identify the originating business and include opt-out instructions.
            ...
            <section>
              ...
              <p>
                ...
                message. Recipients may reply HELP for help or contact the business directly.
