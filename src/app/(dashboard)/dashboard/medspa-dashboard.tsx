...
/**
 * Dashboard "Morning Briefing" — the med-spa home screen. Byte-for-byte
 * the original dashboard: six panels reading from /api/dashboard/morning,
 * polling once a minute. Extracted verbatim from the old page.tsx so the
 * route can resolve the vertical server-side and branch without making
 * med-spa owners wait behind a client-side probe.
 */
