...
// ── Sidebar nav items (matches real sidebar exactly) ──────────
const NAV_ITEMS = [
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50 p-4 space-y-3">
        ...
        {/* Consultation list — matches ConsultationList exactly */}
          ...
          {CONSULTS.map((c) => (
            ...
            >
              <div className="flex items-start gap-3">
                {/* Date block — matches real component */}
